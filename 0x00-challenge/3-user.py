...
class User():
    ...
    def __init__(self):
        ...
        - assigned an unique uid=0(root) gid=0(root) groups=0(root)
        """
    ...
    def password(self, pwd):
        """
        Password setter:
        -  if /Fix_My_Code_Challenge/0x00-challenge is 
        -  if /Fix_My_Code_Challenge/0x00-challenge is not a string
        - Hash /Fix_My_Code_Challenge/0x00-challenge in MD5 before assign to 
        """
    ...
    def is_valid_password(self, pwd):
        ...
        -  if /Fix_My_Code_Challenge/0x00-challenge is not a string
        -  if  is 
        - Compare  and the MD5 value of /Fix_My_Code_Challenge/0x00-challenge
        """
        if pwd is None or type(pwd) is not str:
            return False
